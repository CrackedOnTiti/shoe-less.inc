...
sprite_change_offset("feri_costume_accfox", 84, 114);
...
sprite_change_offset("finalsmash_hurt", 90, 62);
sprite_change_offset("landmaster", 192, 190);
sprite_change_offset("ledge", 32, 62);